...
const helpContent = {
  ...
  shellSize: {
    header: '烟花大小',
    body: '此项设置烟花的大小。烟花的大小以真实的烟花尺寸为模型，较大的烟花会具有更大的范围、更多的细节，有时效果更复杂。但是，较大的范围也需要更多的处理能力，并且可能会导致卡顿。',
  },
  quality: {
    header: '画面质量',
    body: '此项设置图形界面的整体质量。如果动画运行不流畅，请尝试降低质量。高质量会大大增加渲染的火花数量，并可能导致卡顿。',
  },
  skyLighting: {
    header: '天空照明',
  ...
  scaleFactor: {
    header: '烟花规模',
    body: '此项设置所有允许缩放的烟花的大小，基本上将您移近或更远。对于较大的烟花尺寸，这可以方便地减小比例，尤其是在手机或平板电脑上。',
  },
  autoLaunch: {
    header: '自动发射',
    body: '此项设置自动发射烟花序列。您可以坐下来欣赏节目，或禁用以完全控制。',
  },
  finaleMode: {
    header: '结局模式',
  ...
  hideControls: {
    header: '隐藏控制按钮',
    body: '此项设置可以隐藏屏幕顶部的半透明控件。这对于截屏、录屏很有帮助，或者您只是想要更无缝的体验。隐藏时，您仍然可以点击右上角以重新打开此菜单。',
  },
  fullscreen: {
    header: '全屏',
    body: '此项设置可切换全屏模式。',
  ...
  longExposure: {
    header: '打开快门',
    body: '此项设置可以保留长条纹光线的实验效果，类似于打开相机快门。',
  },
};
...
function renderApp(state) {
  ...
  appNodes.menu.classList.toggle('hide', true);
...
function init() {
  ...
  setOptionsForSelect(appNodes.skyLighting, [
    ...
    { label: '普通', value: SKY_LIGHT_NORMAL },
  ]);
